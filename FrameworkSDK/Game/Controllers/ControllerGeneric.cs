...
namespace FrameworkSDK.Game.Controllers
{
    public class Controller<TModel> : Controller
    {
        ...
        protected sealed override void SetModel([NotNull] object model)
        {
            ...
            if (!(model is TModel))
                throw new FrameworkException(string.Format(Strings.Exceptions.Mapping.IncompatibleModelType, model.GetType(), typeof(TModel)));
    ...
    public class Controller<TModel, TView> : Controller
    {
        ...
        protected sealed override void SetView([NotNull] IView view)
        {
            ...
            if (!(view is TView))
                throw new FrameworkException(string.Format(Strings.Exceptions.Mapping.IncompatibleViewType, view.GetType(), typeof(TView)));
