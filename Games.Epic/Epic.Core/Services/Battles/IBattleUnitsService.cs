...
namespace Epic.Core.Services.Battles
{
    public interface IBattleUnitsService
    {
        ...
        Task<IReadOnlyCollection<IBattleUnitObject>> CreateBattleUnitsFromGlobalUnits(IReadOnlyCollection<IGlobalUnitObject> playerUnits, InBattlePlayerNumber playerNumber, Guid battleId, IHeroObject hero);
