...
namespace FrameworkSDK.MonoGame
{
	...
	internal sealed class GameHeart : Microsoft.Xna.Framework.Game, IGameHeart
	{
        ...
        [NotNull]
        private IGameHost GameHost { get; }
        ...
        public GameHeart(
	        [NotNull] IGameHostProvider gameHostProvider,
		...
		{
			if (gameHostProvider == null) throw new ArgumentNullException(nameof(gameHostProvider));
		    ...
		    GameHost = gameHostProvider.GameHost;

		    GameHost.Disposed += GameHostOnDisposed;
