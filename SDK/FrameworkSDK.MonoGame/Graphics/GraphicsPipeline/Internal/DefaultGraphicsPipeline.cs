...
namespace FrameworkSDK.MonoGame.Graphics.GraphicsPipeline
{
    internal class DefaultGraphicsPipeline : ThreePhaseGraphicsPipeline
    {
        ...
        public DefaultGraphicsPipeline([NotNull] IGraphicsPipelineProcessor graphicsPipelineProcessor, IGraphicDeviceContext graphicDeviceContext,
            [NotNull] IRenderTargetsFactoryService renderTargetsFactoryService, [NotNull] IDisplayService displayService)
