...
namespace FrameworkSDK.MonoGame.Graphics.RenderingTools.Internal
{
	[UsedImplicitly]
    internal class SpriteBatchDrawContext : IDrawContextInternal
    {
        private SpriteBatch SpriteBatch { get; }


	    public SpriteBatchDrawContext([NotNull] SpriteBatch spriteBatch)
	    {
