...
namespace FrameworkSDK
{
    ...
    {
        public static bool ContainsWithName([NotNull] this IEnumerable<INamed> enumeration, string name)
        {
	        if (enumeration == null) throw new ArgumentNullException(nameof(enumeration));
	        return enumeration.Any(named => named.Name == name);
        }

        public static bool ContainsWithName([NotNull] this IEnumerable<INamed> enumeration, string name, StringComparison stringComparison)
        {
	        if (enumeration == null) throw new ArgumentNullException(nameof(enumeration));
